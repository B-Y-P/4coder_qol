...
enum{
  ...
  TokenCppKind_int8_t = 144,
  TokenCppKind_int16_t = 145,
  TokenCppKind_int32_t = 146,
  TokenCppKind_int64_t = 147,
  TokenCppKind_uint8_t = 148,
  TokenCppKind_uint16_t = 149,
  TokenCppKind_uint32_t = 150,
  TokenCppKind_uint64_t = 151,
  TokenCppKind_size_t = 152,
  TokenCppKind_ptrdiff_t = 153,
  TokenCppKind_Break = 154,
  TokenCppKind_Case = 155,
  TokenCppKind_Catch = 156,
  TokenCppKind_Continue = 157,
  TokenCppKind_Default = 158,
  TokenCppKind_Do = 159,
  TokenCppKind_Else = 160,
  TokenCppKind_For = 161,
  TokenCppKind_Goto = 162,
  TokenCppKind_If = 163,
  TokenCppKind_Return = 164,
  TokenCppKind_Switch = 165,
  TokenCppKind_Try = 166,
  TokenCppKind_While = 167,
  TokenCppKind_LiteralTrue = 168,
  TokenCppKind_LiteralFalse = 169,
  TokenCppKind_LiteralNull = 170,
  TokenCppKind_NullPtr = 171,
  TokenCppKind_Identifier = 172,
  TokenCppKind_PPInclude = 173,
  TokenCppKind_PPVersion = 174,
  TokenCppKind_PPDefine = 175,
  TokenCppKind_PPUndef = 176,
  TokenCppKind_PPIf = 177,
  TokenCppKind_PPIfDef = 178,
  TokenCppKind_PPIfNDef = 179,
  TokenCppKind_PPElse = 180,
  TokenCppKind_PPElIf = 181,
  TokenCppKind_PPEndIf = 182,
  TokenCppKind_PPError = 183,
  TokenCppKind_PPImport = 184,
  TokenCppKind_PPUsing = 185,
  TokenCppKind_PPLine = 186,
  TokenCppKind_PPPragma = 187,
  TokenCppKind_PPUnknown = 188,
  TokenCppKind_PPDefined = 189,
  TokenCppKind_COUNT = 190,
};
