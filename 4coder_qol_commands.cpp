...
CUSTOM_COMMAND_SIG(toggle_function_tooltip)
CUSTOM_DOC("Toggles the visibility of the function tooltips")
{
  String_ID id = vars_save_string_lit("use_function_tooltip");
